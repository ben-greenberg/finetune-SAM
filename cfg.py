...
def parse_args():    
    ...
    parser.add_argument('-dataset_name', type=str, default='OCT-Ear', help='the name of dataset to be finetuned')
    
    #parser.add_argument('-img_folder', type=str, default='/content/drive/MyDrive/to_Ben_03Sep2024', help='the folder putting images')
    parser.add_argument('-img_folder', type=str, default='/content/drive/MyDrive/correct_dataset/split', help='the folder putting images')
    parser.add_argument('-mask_folder', type=str, default='./datasets/', help='the folder putting masks')
    # parser.add_argument('-train_img_list', type=str, default='/content/drive/MyDrive/to_Ben_03Sep2024/train_5shot.csv')
    # parser.add_argument('-val_img_list', type=str,default='/content/drive/MyDrive/to_Ben_03Sep2024/val_5shot.csv')
    parser.add_argument('-train_img_list', type=str, default='/content/drive/MyDrive/correct_dataset/split/train_full.csv')
    parser.add_argument('-val_img_list', type=str,default='/content/drive/MyDrive/correct_dataset/split/val_full.csv')
    ...
    parser.add_argument('-num_cls', type=int, default=4, help='the number of output channels (need to be your target cls num +1)')
    parser.add_argument('-epochs', type=int, default=200, help='the number of largest epochs to train')
    parser.add_argument('-sam_ckpt', type=str, default='/content/drive/MyDrive/sam_vit_b_01ec64.pth', help='the path to the checkpoint to load')
